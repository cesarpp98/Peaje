...
namespace PeajeApp.GUI
{
    public partial class PanelPrincipal : Form
    {
        ...
        private void registrarVehiculoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            VentanaRegistro.MdiParent = this;
        ...
        {
            ReporteGeneral VentanaReporte = new ReporteGeneral();
        ...
        private void contadorDeVehiculosToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ContadorDeVehiculos ventanacontar = new ContadorDeVehiculos();
            ventanacontar.MdiParent = this;
            ventanacontar.Show();
